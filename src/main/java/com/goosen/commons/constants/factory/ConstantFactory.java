package com.goosen.commons.constants.factory;
...
//    }
    ...
    public String getSingleRoleName(String roleId) {
        if (CommonUtil.isTrimNull(roleId) || roleId == "0") {
            return "--";
        }
        Role roleObj = roleService.findById(roleId);
        if (roleObj != null && !CommonUtil.isTrimNull(roleObj.getName())) {
    ...
    public String getSingleRoleTip(String roleId) {
        ...
        Role roleObj = roleService.findById(roleId);
        if (roleObj != null && CommonUtil.isTrimNull(roleObj.getTips())) {
