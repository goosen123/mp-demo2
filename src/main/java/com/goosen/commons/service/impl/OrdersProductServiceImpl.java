...
@Transactional
@Service
public class OrdersProductServiceImpl extends BaseServiceImpl<OrdersProduct> implements OrdersProductService{
	...
	public List<Map<String, Object>> findByParams(Map<String, Object> params){
		return ordersProductMapper.findByParams(params);
	}
